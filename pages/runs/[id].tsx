...
export default function RunDetailsPage() {
  ...
  // ✅ Instead of router.query (which doesn’t exist in App Router), you may need to pass the id via props or `useParams()`.
  // For now, keeping your structure, but adjust depending on App/Pages Router usage.
  const id =
    ...
    <div style={{ maxWidth: 700, margin: "2rem auto" }}>
      ...
      {loading ? (
        ...
        <div>
          ...
          <p>
            <strong>Client:</strong> {client ? client.name : "-"}
          </p>
          <p>
            <strong>Team:</strong>{" "}
            {team.length > 0
          ...
          <p>
            <strong>Charges:</strong> {run.run_charges}
          </p>
        </div>
      ) : (
        <p>Run not found.</p>
